				...
				<div className="container text-lg px-4">
					<div className="flex flex-wrap md:flex-column mb-8">
						<div className="w-full xl:w-1/2">
							...
							<p className="mt-3">
								„Az uszodák medencéjének vize él” –mivel naponta változó hatásoknak van kitéve. Az
								emberek, a környezet és a természet különböző szervetlen és szerves anyagot juttatnak a
								vízbe. Amennyiben Ön ezt nem veszi tudomásul, akkor medencéjének vize rövid idő alatt
								zavaros pocsolyává válik, mivel a kezeletlen víz a baktériumok és algák szaporodásának
								ideális közege.
							</p>
							...
							<p className="mt-3">
								...
								szennyeződések oxidációjára és a legnagyobb hatékonysággal elpusztítja a baktériumokat.
								A klór felhasználható folyamatos fertőtlenítésre és sokk-kezelésre.
							</p>
							<p className="mt-3 italic">Ki választja a klórt?</p>
							<p className="mt-1">
								Medencetulajdonosok, akik biztonságos és megbízható fertőtlenítési módszert akarnak,
								amely garantálja a higiénikus vizet.
							</p>
							...
							<h2 className="pt-8 pb-2 text-2xl leading-tight font-semibold">
								Algaképződés megakadályozása
							</h2>
							<p className="mt-3">
								Az algaképződés elleni vegyszeres kezelés nélkül a medence vize rövid idő alatt
								bezöldül. A kerti medencék porterhelése és ezzel együtt az alga-spóra terhelése is
								sokkal nagyobb, mint zárt tér esetén. Ebből következik, hogy jobban oda kell figyelni a
								pelyhesítőszer (DINAX FLOCK P) használatra és az alganövekedést gátló szerek (PELYHESÍTŐ
								GÉLTABLETTA vagy TOP FLOCK PELYHESÍTŐ FOLYADÉK) alkalmazására.
							</p>
							...
							<p className="mt-3">
								Ha nincs automata szabályozó berendezésünk és nem figyeljük naponta a víz pH értékét és
								a fertőtlenítőszer szintet, könnyen előfordul, hogy beindul a medencevíz algásodása. Ezt
								a víz opálossá válása és a medencefalak síkossá válása jelzi. Ha nem lépünk azonnal, a
								medencevíz hamarosan zöldes színű átláthatatlan pocsolyává alakul. Ennek
								megakadályozására vagy ha már bekövetkezett a megszüntetésére használjuk az ún. sokkolás
								műveletét. Ilyenkor rövid időn belül a sokszorosára növeljük a fertőtlenítőszer szintet
								(
								<Link to="/termekek#alga_sokk_p" className="link">
									ALGA-SOKK P
								</Link>
								-vel). Ez elpusztítja az algákat és leülepedés után porszívóval el lehet azokat
								távolítani a medencéből. A vízkezelés mért értékeinek beállításához megfelelő mérőcsíkok
						...
						<div className="w-full xl:w-1/2">
							...
							<p className="mt-3">
								Ne hagyjuk, hogy nullára csökkenjen, mert ebben az esetben ugrásszerű szaporodásnak
								indulnak az algák.
							</p>
							<p className="mt-3">
							...
							<p className="mt-3">
								Állítsa be a víz pH-értékét 7,2-7,4 közé, Dinax Mínusz P segítségével. (Ritkán
								előfordul, hogy a pH-értéket növelni kell, ebben az esetben a pH korrigálását ráér a
								sokkolás után elvégezni, mert a klórgranulátum 6-os pH-értéken a leghatékonyabb.)
							</p>
							<p className="mt-3">
							...
							<p className="mt-3">
								A forgatás megkezdése után két-három órával pelyhesítőszert adagolunk a vízhez (Dinax
								Flock F 100 ml), a vízfelszínen egyenletesen elosztva.
							</p>
							<p className="mt-3">
							...
							<p className="mt-3">
								Éjszaka a klór megöli az algákat, a pelyhesítőszer pedig összetapasztja őket
								kiporszívózható pelyhekké.
							</p>
							<p className="mt-3">
							...
							<p className="mt-3">
								Mérje meg a klórkoncentrációt! Ha a klórszint 24 óra alatt 1 mg/l koncentráció alá
								csökken, ez arra utal, hogy a medencében még van alga. Ebben az esetben ismételje meg a
								sokkolást!
							</p>
							<p className="mt-3">
								Ha a klórszint magas, és az is marad, a sokkolás sikeres volt, de Ön nem tud a
								medencében fürdeni, mivel a túl magas klórszint egészségünket veszélyeztetheti.
							</p>
							<p className="mt-3">
								Két dolgot tehet:
						...
						<div className="w-full xl:w-1/2">
							...
							<p className="mt-3">
								A termékek megfelelnek a hazai és a nemzetközi törvényi előírásoknak. A címkén a
								mindenkor érvényben lévő veszély és biztonsági előírások fel vannak tüntetve. A
								csomagolások megfelelnek a veszélyes anyagokra vonatkozó szállítási előírásoknak és a
								biztonság legmagasabb fokát garantálják.
							</p>
							<p className="mt-3">
